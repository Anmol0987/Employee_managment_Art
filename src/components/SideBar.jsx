    ...
    return (
        ...
        <Sidebar backgroundColor="#151632" rootStyles={
            ...
            <Menu rootStyles={{
                ...
                <a className={`flex p-10  h-8 w-full text-white  hover:text-blue-400  ${isCollapsed ? "justify-center" : "justify-start"} items-center`} > <Link to='/attendance/entry/summary'> {isCollapsed ? <CiCalendarDate className='text-2xl' /> : <div className='flex gap-2 justify-center items-center'>  <CiCalendarDate className='text-2xl' /><  h1 className='text-2xl' >Attendence</h1></div>}</Link></a>
                <a className={`flex p-10  h-8 w-full text-white  hover:text-blue-400  ${isCollapsed ? "justify-center" : "justify-start"} items-center`} > <Link to='/leavetracker/mydata/leavesummary'> {isCollapsed ? <MdOutlineTimeToLeave className='text-2xl' /> : <div className='flex gap-2 justify-center items-center'>  <MdOutlineTimeToLeave className='text-2xl' /><  h1 className='text-2xl' >Leave Tracker</h1></div>}</Link></a>
            </Menu>
